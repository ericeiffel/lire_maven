...
public class DocumentBuilderFactory {
    ...
    /**
     * Creates a BGDATA template version of a DocumentBuilder. In this case the
     * {@link net.semanticmetadata.lire.imageanalysis.BGDATA} is used as a feature
     * @return a simple and efficient DocumentBuilder.
     * @see net.semanticmetadata.lire.imageanalysis.BGDATA
     */
    public static DocumentBuilder getBGDATADocumentBuilder() {
        return new GenericFastDocumentBuilder(BGDATA.class, DocumentBuilder.FIELD_NAME_BGDATA);
    }
